...
class AppColors {
  ...
  static const Color buttonActiveColor = Color(0xff4847F1);
  ...
  static const Color columnHeader = Color(0xff1E2943);
  ...
  // floting button color
  static const flotingButtonColor = Color(0xFF603DEB); //Color(0xFF603DEB);
  static const focusFlotingButtonColor = Color(0xFFA8BFFF);
